...
### Onde ir daqui
A experiência do usuário final é um pouco diferente em outros dispositivos móveis. Saiba mais sobre a experiência do usuário final para [iOS](../Solutions/end-user-experience-conditional-access-ios.md) e [Windows Phone](../Solutions/end-user-experience-conditional-access-winphone.md).
