...
description: "Este artigo fornece orientação para profissionais de TI sobre como projetar soluções MDM (Gerenciamento de Dispositivo Móvel), criadas no Enterprise Mobility + Security."
keywords: 
author: andredm7
ms.author: andredm
manager: swadhwa
