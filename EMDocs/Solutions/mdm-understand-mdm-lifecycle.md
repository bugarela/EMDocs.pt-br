...
# Compreender o ciclo de vida do MDM
...
**Estágios do ciclo de vida do gerenciamento de dispositivos móveis**

## Registro e configuração de dispositivo
...
## Questões de planejamento de registro e configuração do dispositivo
...
### Questões de planejamento de gerenciamento de aplicativo
...
##Desativação/cancelamento do registro do dispositivo
...
### Questões de planejamento sobre desativação/cancelamento do registro do dispositivo
