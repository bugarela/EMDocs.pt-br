...
<article id="main">
    <section id="hero-content" class="graph">
        ...
        <h2>Os serviços de mobilidade empresarial da Microsoft permitem que as empresas mantenham seus funcionários mais produtivos entre aplicativos e dispositivos, garantindo a proteção dos dados corporativos</h2>
        <!-- <ol id="actions" class="action-list">
        <li><a href="" class="button button-bordered">Learn More</a></li>
        </ol> -->
        <h3>Ainda não conhece a mobilidade empresarial? <a href="https://www.microsoft.com/server-cloud/enterprise-mobility/overview.aspx" target="_blank">Visite a página de mobilidade empresarial &rarr;</a></h3>
    </section>
