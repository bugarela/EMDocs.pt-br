...
As funcionalidades são recomendadas em três camadas — proteção de linha de base, proteção confidencial e proteção para ambientes com os dados confidenciais ou altamente controlados.
